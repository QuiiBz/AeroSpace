...
@MainActor private func createImplicitContainerAndMoveWindow(
    ...
    // Preserve the original layout instead of forcing tiles
    _ = TilingContainer(parent: workspace, adaptiveWeight: WEIGHT_AUTO, direction.orientation, prevRoot.layout, index: 0)
